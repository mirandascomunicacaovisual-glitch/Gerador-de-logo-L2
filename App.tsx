  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: 'L2 Forge pronta para forjar sua marca. Como posso ajudar com seu servidor hoje?'
    }
  ]);
    ...
    try {
      ...
      if (isVisualRequest) {
        ...
        if (resultImage) {
          ...
          setMessages(prev => [...prev, { id: Date.now().toString(), role: 'assistant', content: 'Forja concluída. Note a precisão da tipografia e do design.' }]);
      ...
      setDetailedError(error?.message || "Erro inesperado na geração.");
